...
public class FileManagerService {
	...
	public ResponseEntity<?> uploadFile(MultipartFile file) throws FileManagerException {
		...
		try {
			...
			String uniqueFileName = "http://" + "" + serverName + ":" + port + "/" + "file/get?file="
					+ saveFileName;
			...
			map.put("message", uniqueFileName);
	...
	private String getServerName() throws FileManagerException {
		try {
			return InetAddress.getLocalHost().getHostAddress();
		} catch (Exception e) {
			e.printStackTrace();
			String message = "Unknown IP Address";
			throw new FileManagerException(message);
		}
	}
